...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 -right-32 w-64 h-64 bg-secondary/20 rounded-full blur-3xl animate-pulse-glow" />
      <div className="absolute bottom-1/4 -left-32 w-64 h-64 bg-primary/20 rounded-full blur-3xl animate-pulse-glow delay-500" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Card */}
        <div className="glass-card rounded-2xl p-8 neon-border-purple animate-fade-in-up">
          <div className="text-center mb-8">
            <h1 className="font-display text-2xl font-bold text-foreground mb-2">
              Hesap Oluşturun
            </h1>
            <p className="text-muted-foreground text-sm">
              LuminaTech ailesine katılın
            </p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-secondary text-secondary-foreground font-display font-bold rounded-xl neon-glow-purple hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
